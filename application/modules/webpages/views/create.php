...
<a href="<?php echo base_url();?>webpages/manage"><button type="button" class="btn btn-default">Back</button></a>
<br><br>
<div class="row-fluid sortable">
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			if ($update_id >2){
				?>
				<a href="<?php echo base_url();?>webpages/deleteconf/<?php echo $update_id; ?>"><button type="button" class="btn btn-danger">Delete Page</button></a>
				<?php } ?>
				<a href="<?php echo base_url().$page_url;?>"><button type="button" class="btn btn-success">View Page</button></a>
			</div>
		</div><!--/span-->
