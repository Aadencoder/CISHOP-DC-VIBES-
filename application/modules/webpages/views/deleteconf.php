...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		echo form_open_multipart('webpages/delete/'.$update_id, $attributes);
		?>
			  <fieldset>
				<div class="control-group">
				  <button type="submit" name="submit" class="btn btn-danger" value="Yes - Delete Page">Yes - Delete Page</button>
