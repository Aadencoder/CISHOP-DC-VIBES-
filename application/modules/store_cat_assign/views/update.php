...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon white user"></i><span class="break"></span>Assigned Categories For this Item</h2>
			<div class="box-icon">
		...
		<div class="box-content">
			<table class="table table-striped table-bordered bootstrap-datatable ">
			  ...
			  foreach ($query->result() as $row) {
			  		...
			  		$parent_category_title = $this->store_categories->_get_parent_cat_title($row->cat_id);
			  		$cat_title = $this->store_categories->_get_cat_title($row->cat_id);
			  		$long_cat_title = $parent_category_title." > ".$cat_title;
			  	?>
				<tr>
