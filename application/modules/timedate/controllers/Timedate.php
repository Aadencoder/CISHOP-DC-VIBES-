...
function get_nice_date($timestamp, $format)
{
    ...
    {
        case 'full':
        // FULL // Friday 18th of Feburary 2011 at 10:00:00 AM
        $the_date = date('l jS \of F Y \a\t h:i:s A', $timestamp);
        break;
        case 'cool':
        // FULL // Friday 18th of Feburary 2011
        $the_date = date('l jS \of F Y', $timestamp);
        break;
        case 'shorter':
        // SHORTER // 18th of Feburary 2011
...
function make_timestamp_from_datepicker($datepicker)
{
    ...
    $timestamp = $this->mktime($hour, $minute, $second, $month, $day, $year);
    return $timestamp;
}
