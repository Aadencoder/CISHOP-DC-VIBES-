...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<p>
		<?php 
		$edit_url = base_url()."store_items/create/".$update_id; ?>
		<a href="<?php echo $edit_url; ?>"><button type="button" class="btn btn-primary">Return Update Item Detail Page</button></a></p>
		</div>
	</div><!--/span-->
