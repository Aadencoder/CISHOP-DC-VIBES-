...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<a href="<?php echo base_url();?>homepage_blocks/manage"><button type="button" class="btn btn-success">Back</button></a>
		...
		<a href="<?php echo base_url();?>homepage_blocks/deleteconf/<?php echo $update_id; ?>"><button type="button" class="btn btn-danger">Delete Offer</button></a>
		</div>
	</div><!--/span-->
		...
		<form class="form-horizontal" method="post" action="<?php echo $form_location; ?>">
		  <fieldset>
			<div class="control-group">
			  <label class="control-label" for="Block Title">Offer Block Title </label>
			  <div class="controls">
