...
{
    //delete any slides hat are associated with this offer 
    $this->load->module('slides');
...
function view($update_id)
{
    if(!is_numeric($update_id)) {
     ...
     //count the item that belong to this Slider
     $use_limit = FALSE;
    ...
    if ($submit == "Submit"){
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (is_numeric($update_id)) {
                ...
                //insert net Slider
                $this->_insert($data);
                $update_id = $this->get_max(); //get the id of new Slider
