...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>CISHOP | ADMIN PANEL</title>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span style="color:#b8281e; text-shadow: 2px 2px #444; font-weight: bold;">CISH<img src="<?php echo base_url(); ?>adminfiles/img/guitar.png" class="img-responsive" width="40px" height="30px" style="padding: 2px; padding-top: 4px; padding-right: 10px;" >P</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						?>
						<li><a href="<?php echo base_url(); ?>sliders/manage"><i class="icon-picture"></i><span class="hidden-tablet"> Manage Slider(s)</span></a></li>
						<li><a href="<?php echo base_url(); ?>store_order_status/manage"><i class="icon-file-alt"></i><span class="hidden-tablet"> Order Status</span></a></li>
						...
						<li><a href="<?php echo base_url(); ?>homepage_blocks/manage"><i class="icon-star"></i><span class="hidden-tablet"> Home Page Offers</span></a></li>
